    ...
    <div className="max-w-3xl">
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0">
          <div className="flex items-center gap-3">
            <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{tenant.name}</h1>
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="bg-white rounded-xl border border-gray-100 dark:border-gray-700 dark:bg-gray-800 p-4">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{tenant.member_count}</p>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 dark:border-gray-700 dark:bg-gray-800 p-4">
          <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-1">Invoices</p>
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{tenant.invoice_count}</p>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 dark:border-gray-700 dark:bg-gray-800 p-4">
          <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-1">Revenue processed</p>
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{formatGHS(tenant.paid_revenue)}</p>
        </div>
      </div>

      {/* Details */}
      <div className="bg-white rounded-xl border border-gray-100 dark:border-gray-700 dark:bg-gray-800 p-5 space-y-4">
        <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Subscription details</h2>
        <div className="grid grid-cols-1 gap-4 text-sm sm:grid-cols-2">
          <div>
            <p className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-1">Plan</p>
            <p className="font-medium text-gray-900 dark:text-gray-100">{tenant.plan}</p>
          </div>
          <div>
